...
# 1) android.add_assets = source_dir/assets/files (in the assets folder by the apk builder)
# 2) android.add_assets = source_dir/assets/files:destination_path (the path in the APK's assets)
#android.add_assets =
...
# 2) A directory, here  'legal_resource_name' directory name will be used as resource name
# android.add_resources = legal_resource_name:path/to/directory
# 3) A directory, here parent directory name will be used as resource name
# android.add_resources = path/to/directory/legal_resource_name
...
# Start with one arch for faster builds, add more later
...
# (str) python-for-android fork to use in case if p4a.branch is not specified, defaults to kivy
#p4a.fork = kivy
...
# setup.py if you're using Poetry, but you need to set this to true to use pyproject.toml
# p4a.setup_py = false

# (str) python-for-android URL, to use a custom fork
# p4a.url =

# (int) python-for-android numeric version, to use a custom version
# p4a.numeric_version = 
